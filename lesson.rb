class Lesson < ActiveRecord::Base
  belongs_to :pre_assignment, class_name: "Assignment", foreign_key: "pre_class_assignment_id"
  has_many :readings, dependent: :destroy
  belongs_to :course
  belongs_to :in_class_assignment, class_name: "Assignment", foreign_key: "in_class_assignments_id"
